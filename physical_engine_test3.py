...
#ball_locating()
red1.r = np.array([-0.3535,0.3535,0.0])
yellow1.r = np.array([0.866,-0.5,0.0])
...
wy_input = 5.0
wz_input = 0.0
red1.shoot(0.5, 2*np.pi*(-45)/360, 0.5, 0.0, 0.0)
yellow1.shoot(1.0, 2*np.pi*(150)/360, 1.0, 0.0, 0.0)
print('red1.v = ',red1.v)
print('red1.w = ',red1.w)
print('yellow1.v = ',yellow1.v)
print('yellow1.w = ',yellow1.w)
...
for time in range(0,T):
    ...
    # 데이터 기록
    Xr.append(red1.r[0]+0.5*table_len)
    Yr.append(red1.r[1]+0.5*table_wid)
    Xy.append(yellow1.r[0]+0.5*table_len)
    Yy.append(yellow1.r[1]+0.5*table_wid)

plt.scatter(Xr,Yr, c="r",marker='.')
plt.scatter(Xy,Yy, c='y',marker='.')
